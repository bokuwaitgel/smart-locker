...
import { CreateLockerDto, UpdateLockerDto, LockerStatsDto, BulkUpdateLockersDto } from './dto';
...
export class LockerController {
  ...
  @ApiQuery({ name: 'boardId', required: false, description: 'Filter by container board ID' })
  @ApiResponse({ status: 200, description: 'Available lockers retrieved successfully' })
  ...
  @ApiQuery({ name: 'boardId', required: false, description: 'Container board ID for more specific search' })
  @ApiResponse({ status: 200, description: 'Locker retrieved successfully' })
  @ApiResponse({ status: 404, description: 'Locker not found' })
  ...
  @ApiQuery({ name: 'boardId', required: false, description: 'Container board ID' })
  ...
  @ApiResponse({ status: 200, description: 'Locker status updated successfully' })
  @ApiResponse({ status: 403, description: 'Forbidden - Admin access required' })
