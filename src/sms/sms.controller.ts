...
export class SmsController {
  ...
  @ApiResponse({
    status: 200,
    description: 'Pickup code SMS sent successfully',
  })
  async sendPickupCode(@Body() data: PickupCodeDto) {
    return this.smsService.sendPickupCode(
      data.phone,
      data.lockerLocation,
      data.code,
      data.deliveryId || 0,
  ...
  @ApiResponse({
    status: 200,
    description: 'Delivery code SMS sent successfully',
  })
  ...
  @ApiResponse({
    status: 200,
    description: 'Delivery notification SMS sent successfully',
  })
